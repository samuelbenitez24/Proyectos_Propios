...
const {Login, create_User, Duplicate_user,lockedUser,validar_Campos_Login}=require("../middleware/validarUser");
 ...
 *         usuario:
 *           type: string
 *           example: "tuguacha234435"
 *         password:
 *           type: string
 *           example: "435dasd34534534"
 *       required:
 *         - usuario
 *         - password
 *     SingUp:
 ...
 * 
 */
router.post('/login',[Login,validar_Campos_Login,lockedUser],singnin);
...
router.put('/modification/:id',[autenticarUsaurio,isAdmin],put_user);

/**
 * @swagger
 * /api/users/lockedUser/{id}:
 *  put:
 *    summary: update user
 *    description: update user information
 *    security:
 ...
 *        
 */
router.put('/lockedUser/:id',[autenticarUsaurio,isAdmin],put_locked);
...
router.delete('/delete/:id',[autenticarUsaurio,isAdmin],Delete_user);
