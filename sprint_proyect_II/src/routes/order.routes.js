...
const{ Validar_Id_Order,Validar_New_order,validar_cantidad_product,validar_Productos, Validar_Id_product, Validar_order_state, Validar_New_order_waypay}=require("../middleware/validarOrder");
 ...
 * 
 */
 router.delete('/delete_product/num_product/:num_product',[autenticarUsaurio/* ,Validar_Id_product */],delete_order);
